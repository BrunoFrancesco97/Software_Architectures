...
A user can send requests to the API layer thanks to a list of fixed endpoints that are the same as task 3 ones so for space reasons they are omitted from being displayed here (see Task _Task 3/backend/server/_ README).
