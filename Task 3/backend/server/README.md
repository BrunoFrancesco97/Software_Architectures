...
TYPE: GET
BODY: NONE
ENDPOINT USED IN ORDER TO GET ALL NO PRIVATE INFORMATION OF MY USER
```
```
URL: /login
TYPE: GET
...
ENDPOINT USED IN ORDER TO GET ALL FILES AND ASSIGNMENTS OF A SPECIFIC COURSE WHICH NAME IS SPECIFIED INSIDE THE ENDOPOINT
```
```
URL: /course
PERMISSIONS: LOGIN REQUIRED
